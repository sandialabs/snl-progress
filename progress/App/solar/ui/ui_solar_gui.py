...
class Ui_solar_widget(object):
    ...
    def retranslateUi(self, solar_widget):
        ...
        self.pushButton_help_solar.setText(QCoreApplication.translate("solar_widget", u"?", None))
        ...
        self.pushButton_api_8.setText(QCoreApplication.translate("solar_widget", u"?", None))
